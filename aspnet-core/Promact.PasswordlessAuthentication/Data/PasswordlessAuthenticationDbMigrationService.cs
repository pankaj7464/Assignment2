...
public class PasswordlessAuthenticationDbMigrationService : ITransientDependency
{
    ...
    private readonly PasswordlessAuthenticationEFCoreDbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public PasswordlessAuthenticationDbMigrationService(
        IDataSeeder dataSeeder,
        PasswordlessAuthenticationEFCoreDbSchemaMigrator dbSchemaMigrator,
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "Promact.PasswordlessAuthentication");
    }
